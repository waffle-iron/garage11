 ...
 * Ractivejs is used as an example, but this can be done with any virtual
...
class VDom {
    ...
    initRenderer() {
        this.peer.logger.info(`[vdom] init virtualdom (ractivejs)`)
        ...
        if(!this.renderer) {
            ...
            let ractiveOptions = {
                ...
                data: {
                    ...
                    current: 'blog-list',
                    peer: this.peer,
                    currentNode: this.peer.network.currentNode,
                },
            }
            ...
            this.renderer.set('permissions.user.read[currentNode.id]', true)
